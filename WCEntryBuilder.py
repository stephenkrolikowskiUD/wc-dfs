...
def sample_picks() -> list[dict[str, Any]]:
    raw = [
        {"Player": "Santiago Gimenez", "Team": "Mexico", "Prop": "Shots", "Line": "2.5", "Pick": "Over", "Tier": "SMASH", "Confidence": 9, "Intl_Sample": 16},
        {"Player": "Edson Alvarez", "Team": "Mexico", "Prop": "Tackles", "Line": "2.5", "Pick": "Over", "Tier": "STRONG", "Confidence": 8, "Intl_Sample": 18},
        {"Player": "Raul Jimenez", "Team": "Mexico", "Prop": "SOT", "Line": "0.5", "Pick": "Over", "Tier": "STRONG", "Confidence": 7, "Intl_Sample": 20},
        {"Player": "Lyle Foster", "Team": "South Africa", "Prop": "Shots", "Line": "1.5", "Pick": "Over", "Tier": "SMASH", "Confidence": 8, "Intl_Sample": 10},
        {"Player": "Teboho Mokoena", "Team": "South Africa", "Prop": "Tackles", "Line": "1.5", "Pick": "Over", "Tier": "STRONG", "Confidence": 7, "Intl_Sample": 12},
        {"Player": "Patrik Schick", "Team": "Czechia", "Prop": "Goal Scorer", "Line": "0.5", "Pick": "Over", "Tier": "SMASH", "Confidence": 8, "Intl_Sample": 14},
        {"Player": "Son Heung-min", "Team": "South Korea", "Prop": "Shots", "Line": "2.5", "Pick": "Over", "Tier": "LEAN", "Confidence": 6, "Intl_Sample": 24},
    ]
...
def run(dry_run: bool = False, sample: bool = False) -> list[dict[str, Any]]:
    ...
    print(f"🎫 Built {slip_count} slip recommendation(s), {len(rows)} leg row(s)")
